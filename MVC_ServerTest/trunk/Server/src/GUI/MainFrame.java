...
*/
public class MainFrame extends javax.swing.JFrame implements WindowListener, FocusListener, ListSelectionListener {
	...
	public StatusCommandPanel statusCommandPanel1;
	private JScrollPane jScrollPane4;
	private JScrollPane jScrollPane1;
	private JPanel jPanel4;
	private JPanel jPanel3;
	private JPanel statusViewerPanel;
	public ClientTable jTable1;
	private JScrollPane jScrollPane3;
	public ClientCommandPanel clientCommandPanel1;
	...
	*/
	...
	public MainFrame(ActionContainer actionContainer) {
		super();
	...
	private AbstractAction getExitAction() {
		if(exitAction == null) {
			exitAction = actionContainer.getExitAction();
		}
		return exitAction;
	}
	...
	private ClientCommandPanel getClientCommandPanel1() {
		if(clientCommandPanel1 == null) {
			clientCommandPanel1 = new ClientCommandPanel(getActionContainer());			
	...
	private StatusCommandPanel getStatusCommandPanel1() {
		if(statusCommandPanel1 == null) {
			statusCommandPanel1 = new StatusCommandPanel(actionContainer);			
